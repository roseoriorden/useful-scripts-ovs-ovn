...
ovs-vsctl --db=unix:/home/rose/tmp-ovs/conf2.sock add-br br-ext2
ovs-vsctl --db=unix:/home/rose/tmp-ovs/conf2.sock add-port br-ext2 ovs-second0
...
sudo -E /home/rose/ovn/controller/ovn-controller --detach --no-chdir -vsyslog:off --pidfile=/home/rose/tmp-ovn/ovn-controller2.pid --log-file=/home/rose/tmp-ovn/ovn-controller2.log -vconsole:off unix:/home/rose/tmp-ovs/conf2.sock
...
sudo ip netns exec ovs-second ovs-vsctl --db=unix:/home/rose/tmp-ovs/conf2.sock add-port br-int2 carol0
